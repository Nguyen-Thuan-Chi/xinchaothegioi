...
namespace xinchaothegioi.Utilities
{
    ...
    public static class AppUtils
    {
        ...
        /// </summary>
        /// <param name="message">N?i dung th?ng b?o</param>
        /// <param name="title">Ti?u ?? (m?c ??nh: "L?i")</param>
        public static void ShowError(string message, string title = "L?i")
        {
        ...
        /// </summary>
        /// <param name="message">N?i dung th?ng b?o</param>
        /// <param name="title">Ti?u ?? (m?c ??nh: "C?nh b?o")</param>
        public static void ShowWarning(string message, string title = "C?nh b?o")
        {
            MessageBox.Show(message, title, MessageBoxButtons.OK, MessageBoxIcon.Warning);
        }
        
        /// <summary>
        /// Hi?n th? th?ng b?o th?ng tin
        /// </summary>
        /// <param name="message">N?i dung th?ng b?o</param>
        /// <param name="title">Ti?u ?? (m?c ??nh: "Th?ng b?o")</param>
        public static void ShowInfo(string message, string title = "Th?ng b?o")
        {
        ...
        /// </summary>
        /// <param name="message">N?i dung c?u h?i</param>
        /// <param name="title">Ti?u ?? (m?c ??nh: "X?c nh?n")</param>
        /// <returns>True n?u ng??i d?ng ch?n Yes</returns>
        public static bool ShowConfirm(string message, string title = "X?c nh?n")
        {
            return MessageBox.Show(message, title, MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes;
        }
        
        /// <summary>
        /// Thi?t l?p tooltip cho control
        /// </summary>
        /// <param name="control">Control c?n thi?t l?p tooltip</param>
        /// <param name="text">N?i dung tooltip</param>
        ...
        /// <summary>
        /// Thi?t l?p font cho control
        /// </summary>
        /// <param name="control">Control c?n thi?t l?p font</param>
        /// <param name="fontName">T?n font</param>
        /// <param name="fontSize">K?ch th??c font</param>
        /// <param name="style">Ki?u font</param>
        public static void SetFont(Control control, string fontName = "Arial", float fontSize = 9, FontStyle style = FontStyle.Regular)
        {
