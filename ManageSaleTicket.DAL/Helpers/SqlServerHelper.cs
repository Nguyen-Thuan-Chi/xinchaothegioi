...
namespace xinchaothegioi.Helpers
{
    public static class SqlServerHelper
    {
        ...
        {
            // Prefer value from ConfigHelper (env-based in this DAL project)
            var cs = ConfigHelper.GetConnectionString("DefaultConnection");
        ...
        public static void CreateDatabaseIfNotExists()
        {
            try
            {
                ...
                var baseCs = GetConnectionString() ?? string.Empty;
                string masterConnectionString = baseCs.Replace("XinChaoTheGioiDB", "master");
